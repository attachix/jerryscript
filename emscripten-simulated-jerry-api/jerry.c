 ...
 *         false - otherwise
 */
bool jerry_value_is_boolean (const jerry_value_t value) /**< api value */
{
 ...
 *         false - otherwise
 */
bool jerry_value_is_constructor (const jerry_value_t value) /**< api value */
{
 ...
 *         false - otherwise
 */
bool jerry_value_is_function (const jerry_value_t value) /**< api value */
{
 ...
 *         false - otherwise
 */
bool jerry_value_is_number (const jerry_value_t value) /**< api value */
{
 ...
 *         false - otherwise
 */
bool jerry_value_is_null (const jerry_value_t value) /**< api value */
{
 ...
 *         false - otherwise
 */
bool jerry_value_is_object (const jerry_value_t value) /**< api value */
{
  return (bool) EM_ASM_INT (
    {
 ...
 *         false - otherwise
 */
bool jerry_value_is_string (const jerry_value_t value) /**< api value */
{
 ...
 *         false - otherwise
 */
bool jerry_value_is_undefined (const jerry_value_t value) /**< api value */
{
 ...
 */
bool jerry_get_boolean_value (const jerry_value_t value) /**< api value */
{
 ...
 */
double jerry_get_number_value (const jerry_value_t value) /**< api value */
{
 ...
 */
jerry_size_t jerry_get_utf8_string_size (const jerry_value_t value) /**< api value */
{
